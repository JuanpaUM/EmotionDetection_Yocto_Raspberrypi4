...
emotion_model = load_model('5cat_emotion_detection_model_100epochs.h5', compile=False)
...
open("5cat_emotion_detection_model_100epochs_no_opt.tflite", "wb").write(tflite_model)
